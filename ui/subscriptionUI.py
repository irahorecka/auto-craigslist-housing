...
from utils.get_static_file import qcombo_box
...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.qcombo_box = utils.qcombo_box()
        ...
        self.subscription_craigslist_header.setPixmap(QtGui.QPixmap("./ui/image/craigslist.png"))
        self.subscription_craigslist_header.setScaledContents(True)
        self.subscription_craigslist_header.setObjectName("subscription_craigslist_header")
        ...
        self.go.setGeometry(QtCore.QRect(190, 300, 113, 40))
        ...
        self.hours_selected = None
        self.go.clicked.connect(self.get_hours)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.subscription_sublabel.setText(_translate("Dialog", "Automated emails will be sent once per specified hour."))
        self.go.setText(_translate("Dialog", "Go!"))
        self.subscription_label.setText(_translate("Dialog", "Would you like automated notifications?"))

    def get_hours(self):
        print(self.get_qcombo_int(self.hours))
